...
export default function AboutPage() {
  return (
    <>
      <PageHero title="About Shivam Automobiles" eyebrow="Established 2017">Authorized Mahindra workshop led by {business.owner}, serving Ranchi with dependable repairs and genuine spare parts.</PageHero>
      <section className="section">
        <div className="container-pad grid gap-6 md:grid-cols-3">
          {[
            ["Mission", "Deliver accurate repairs, genuine parts, and timely workshop support."],
      ...
      <section className="bg-muted py-14">
        <div className="container-pad">
          ...
          <div className="mt-6 grid gap-4 md:grid-cols-2">
            <Card><CardHeader><CardTitle>2017</CardTitle></CardHeader><CardContent>Shivam Automobiles begins authorized workshop and genuine spare parts operations.</CardContent></Card>
