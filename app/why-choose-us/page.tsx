...
export default function WhyChooseUsPage() {
  return (
    <>
      <PageHero title="Why Choose Shivam Automobiles" eyebrow="Workshop Advantage">Reliable repairs, genuine inventory, and customer-focused service since 2017.</PageHero>
        ...
        <div className="container-pad grid gap-5 md:grid-cols-2 lg:grid-cols-3">
          {features.map(([title, Icon]) => (
            <Card key={String(title)}>
              ...
              <CardContent className="text-sm text-muted-foreground">Premium workshop processes, careful diagnosis, and dependable follow-through for Mahindra owners.</CardContent>
            </Card>
          ))}
        </div>
      </section>
